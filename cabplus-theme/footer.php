...
<footer id="site-footer">
  <div class="wrap">
    <div class="foot-grid">
      ...
      <div class="foot-col">
        ...
        <div class="foot-links-col">
          ...
          <a href="<?php echo esc_url(home_url('/#housing')); ?>">Housing</a>
      ...
      <div class="foot-col">
        ...
        <div class="foot-contact">
          ...
          <p style="margin-top:8px;font-size:0.82rem;color:var(--cream-muted);">UK-based independent consultancy</p>
          <a href="<?php echo esc_url(home_url('/contact')); ?>" class="btn btn-gold" style="margin-top:16px;display:inline-flex;">Get in touch</a>
        </div>
      </div>
    ...
    <a href="https://wa.me/447752666100" target="_blank" rel="noopener noreferrer" class="whatsapp-float" aria-label="Chat with CABPLUS on WhatsApp">
        ...
        <span class="whatsapp-float-tooltip">Chat with us on WhatsApp (+44 7752 666100)</span>
    </a>
